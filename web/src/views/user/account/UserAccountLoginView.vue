            ...
            <div class="col-3">
                <form @submit.prevent="login">
                    ...
                    <div class="mb-3">
                        ...
                        <input v-model="password" type="password" class="form-control" id="passoword"
                            placeholder="请输入密码">
                    </div>
...
export default {
    ...
    setup() {
        ...
        const acwing_login = () => {
            $.ajax({
                url: "https://app3277.acapp.acwing.com.cn/api/user/account/acwing/web/apply_code/",
                type: "GET",
                success: resp => {
                    if (resp.result === "success") {
                        window.location.replace(resp.apply_code_url); //重定向回调地址
                    }
                }
            })
        }
